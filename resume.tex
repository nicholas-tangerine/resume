...
\begin{itemize}
    ...
    \item Exposure to and translation between HDF5, NetCDF, TIFF, other various file formats.
...
\textbf{Tools/DevOps:} & Git, CMake, Ninja, Docker, Valgrind, GNU Make, GDB, Vi \\
