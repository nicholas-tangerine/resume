...
\begin{itemize}
    \item Developing firmware for a custom electric vehicle for the FSAE international \\
    ...
    \item Managed 10 MHz UART communication with VN-200 for performant IMU and GPS data \\
        acquisition.
    ...
    \item Engineered safety-critical power delivery systems, implementing LV undervolting detection \\
        and relay actuation.
\end{itemize}
...
\textbf{NASA Professional Development Program} \hfill June 2025 -- Aug 2025 \\
